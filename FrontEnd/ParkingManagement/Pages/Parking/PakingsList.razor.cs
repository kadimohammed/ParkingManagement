...
{
    public partial class PakingsList
    {
        [Inject]
        ...
        public IList<GetParkingsResponse>? FilteredParkingList { get; set; } = null;
        ...
        private void SearchParkings(ChangeEventArgs e)
        {
            ...
            {
                FilteredParkingList = ParkingList?
                    .Where(p => p.NomParcking.ToLower().Contains(searchText) || 
                               p.Adresse.ToLower().Contains(searchText))
                    .ToList();
            }
        }
        ...
        private async Task SupprimerParking(int id)
        {
            ...
            if (confirmed)
            {
                ...
                if (res is not null)
                {
                    ...
                    FilteredParkingList = new List<GetParkingsResponse>(ParkingList);
                }
            }
        }
    }
