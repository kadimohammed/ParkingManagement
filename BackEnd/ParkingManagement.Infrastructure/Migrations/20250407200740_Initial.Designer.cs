...
namespace ParkingManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250407200740_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkingManagement.Core.Entities.Picture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ParkingManagement.Core.Entities.PictureParking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ParkingManagement.Core.Entities.PictureParking", b =>
                {
                    b.HasOne("ParkingManagement.Core.Entities.Parking", "Parking")
                        .WithMany("PicturesParking")
                        .HasForeignKey("ParkingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ParkingManagement.Core.Entities.Picture", "Picture")
                        .WithMany("PicturesParking")
